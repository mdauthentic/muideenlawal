        ...
        <div className="hero-grid">
          <div className="heroBox">
            ...
            <div className="btnWrapper">
              <Link className="socialBtn hw-2 br-2" href="#">
        ...
        <div className="featuredBox">
          <div className="titleContent">
            ...
            <div className="readMore">
              ...
              <a href="/" className="readMoreText">see all</a>
            </div>
          </div>
...
const projects = [
  { id: 1, git: "https://github.com/mdauthentic", title: "refined-SQL", description: "An opinionated SQL syntax. SQL syntax refined to be shorter and concise. A parser for the dialect is written in Rust using Nom parser.", tags: "#LanguageSpec, #Rust, #Nom, #Parsing" },
  { id: 2, git: "https://github.com/mdauthentic", title: "NextJs Portfolio", description: "This website that you are currently on. Built with NextJs, Typescript, Contentlayer for typed markdown generation and deployed on Vercel.", tags: "#NextJs, #Contentlayer, #MDX, #Vercel" },
  { id: 3, git: "https://github.com/mdauthentic", title: "Commune API", description: "API for retrieving information about high schools in France and postal codes for all communities in France.", tags: "#FastAPI, #Python3, #RethinkDB, #Docker, #RestAPI" },
            ...
            <div className="item" key={project.id}>
              <div className="projectCard">
                <div className="flexSpaceBtw">
                  <Link href="/" className="cardHeader">{project.title}</Link>
